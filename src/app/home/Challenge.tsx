        ...
        <section className="flex flex-row w-full gap-12 h-screen items-center relative" ref={containerRef}>
            ...
            {containerRef.current && <div className=" absolute inset-0" >
                <Image
                    ...
                    style={{ transform: `translateY(${-((windowScroll.y - top + (containerRef.current.getBoundingClientRect().height / 2)) / 2)}px)` }}
                />
                ...
                <Image
                    ...
                    style={{ transform: `translateY(${-((windowScroll.y - top + (containerRef.current.getBoundingClientRect().height / 2)) / 5)}px)`}}
                ...
                <Image
                    ...
                    style={{ transform: `translateY(${-((windowScroll.y - top + (containerRef.current.getBoundingClientRect().height / 2)) / 6)}px)` }}
