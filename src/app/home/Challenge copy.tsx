...
export default function Challenge() {
    return (
        <section className="flex flex-row w-full gap-12 items-center">
            <div className="flex-1 h-[500px] flex flex-row gap-4">
                <div className="flex flex-col gap-6 -mt-12">
                    <Goal title="Flashcards" description="Learn 5 minutes at a time" tag="in app"
                        icon={<Image
                            src="https://cdn-icons-png.flaticon.com/512/25/25231.png"
                            alt="farcaster" width={30} height={30} />} />
            ...
            <ThreeHeaders title="Define your goal" subTitle="goals" paragraph="Chose from challenges library and connect relevant apps" />
        </section>
    )
}